...
Once the `conda-forge` channel has been enabled, `puremagic` can be installed with:

```
conda install puremagic
```

It is possible to list all of the versions of `puremagic` available on your platform with:
